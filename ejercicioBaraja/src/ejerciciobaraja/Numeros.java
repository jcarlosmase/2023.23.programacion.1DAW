...
public class Numeros {
    ...
    public static void main(String[] args) {
        ...
        int numero1 = Aleatorio(0,1000);
        int numero2 = Aleatorio(-10,10);
        int numero3 = Aleatorio(-5,5);
        
        //esCapicua
        if(esCapicua(numero1)){
            System.out.println(numero1 + " SI es Capicua");
        }else{
            System.out.println(numero1 + " NO es Capicua");
        }
        
        //esPrimo
        if(esPrimo(numero1)){
            System.out.println(numero1 + " SI es Primo");
        }else{
            System.out.println(numero1 + " NO es Primo");
        }
        
        //siguientePrimo
        System.out.println("El siguiente número primo de "+numero1+" es "+siguientePrimo(numero1));
        
        //potencia
        System.out.println(numero2+"^"+numero3+"="+potencia(numero2,numero3));
        
        //digitos
        System.out.println(numero1+" tiene "+digitos(numero1)+" dígitos.");
        
        //voltea
        System.out.println("El número "+numero1+" volteado es "+voltea(numero1));
        
        //quitaPorDetras
        System.out.println(quitaPorDetras(121234,2));
    }
